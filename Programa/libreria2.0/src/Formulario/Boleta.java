...
public class Boleta extends javax.swing.JInternalFrame {
    ...
    //metodo que se usa para descactivar algunos texfield
    public Boleta() {
        initComponents();
    ...
    //metodo para seleccionar un procucto segun su codigo
    ...
    //metodo que sirve para generar el codigo de la boleta
    void numeros() {
    ...
    //metodo para calcular los precios de la boleta
    void calcular() {
        String pre;
        String can;
        double igv = 0;
    ...
    //metodo para realizar una nueva venta de boleta
    void boleta() {
    ...
    //metodo para ingresar los detalles de la boleta
    void detalleboleta() {
        for (int i = 0; i < tbdetbol.getRowCount(); i++) {
