...
public class IngresoClienteUser extends javax.swing.JInternalFrame {

    DefaultTableModel model;

    public IngresoClienteUser() {
        initComponents();
        bloquear();
        cargar("");
    ...
    void cargar(String valor) {
        ...
        try {
            ...
            Logger.getLogger(IngresoClienteUser.class.getName()).log(Level.SEVERE, null, ex);
        }
