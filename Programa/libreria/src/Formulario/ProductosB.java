...
public class ProductosB extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Ana\\Desktop\\libreria\\src\\Imagenes\\ayuda.png")); // NOI18N
    ...
    try {
        ...
        if (fila == -1) {
            ...
            if ((cant.equals("")) || (cant.equals("0"))) {
                JOptionPane.showMessageDialog(this, "Debe ingresar algun valor mayor que 0", "Error!", JOptionPane.ERROR_MESSAGE);
//            JOptionPane.showMessageDialog(this, "Debe ingresar algun valor mayor que 0");
            } else {
                int canting = Integer.parseInt(cant);
                int comp = Integer.parseInt(comparar(codins));
                if (canting > comp) {
                    JOptionPane.showMessageDialog(this, "Ud. no cuenta con el stock apropiado", "Error!", JOptionPane.ERROR_MESSAGE);
