...
public class ConsultasBoletasUser extends javax.swing.JInternalFrame {

    public ConsultasBoletasUser() {
        initComponents();
        cargartodasBoletas();
    ...
    void cargartodasBoletas() {
        ...
        try {
            ...
            Logger.getLogger(ConsultasBoletasUser.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
// TODO add your handling code here:
    ...
    if (filasele == -1) {
        ...
        DetalleBoletaUser detalle = new DetalleBoletaUser();
        ...
        DetalleBoletaUser.txtfac.setText(numbol);
        DetalleBoletaUser.txtcod.setText(cod);

        DetalleBoletaUser.txttot.setText(total);
        DetalleBoletaUser.txtfecha.setText(fecha);
        DefaultTableModel model = (DefaultTableModel) DetalleBoletaUser.tbdetalle.getModel();
        ...
        try {
            ...
            DetalleBoletaUser.tbdetalle.setModel(model);
        } catch (SQLException ex) {
            Logger.getLogger(ConsultasBoletasUser.class.getName()).log(Level.SEVERE, null, ex);
        }
...
//    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(null,
                "Para realizar una consulta de las boletas puede"
                + "\n" + "escoger tres opciones :"
                + "\n" + ""
                + "\n" + "1.- Buscar por el codigo de la boleta"
                + "\n" + "2.- Buscar por la fecha con el calendario"
                + "\n" + "3.- Mostrar todas las boletas ");
