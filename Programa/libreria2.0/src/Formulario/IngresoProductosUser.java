...
public class IngresoProductosUser extends javax.swing.JInternalFrame {

    DefaultTableModel model;

    public IngresoProductosUser() {
        initComponents();
...
// TODO add your handling code here:
    ...
    try {
        ...
        if (txtdes.getText().equals("")) {
            JOptionPane.showMessageDialog(this, "No dejar campo nombre vacio", "Error!", JOptionPane.ERROR_MESSAGE);
        ...
        Logger.getLogger(IngresoProductosUser.class.getName()).log(Level.SEVERE, null, ex);
    }
...
// TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JOptionPane.showMessageDialog(null,
                "En esta ventana se ingresara los datos del producto."
                + "\n" + "No modifique el codigo ya que el sistema colocara"
                + "\n" + "uno automaticamente.Ademas todos los campos son"
                + "\n" + "obligatorios");
